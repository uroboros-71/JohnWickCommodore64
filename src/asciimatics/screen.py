...
from asciimatics.exceptions import ResizeScreenError, StopApplication, NextScene, TransmitApplication
...
class Screen(_AbstractCanvas, metaclass=ABCMeta):
    ...
    @return_scene.setter
    def return_scene(self, new_value):
        self._return_scene=new_value
...
if sys.platform == "win32":
    ...
    class _CursesScreen(Screen):
        ...
        def __init__(self, win, height=None, catch_interrupt=False,
            ...
            self._signal_state.set(signal.SIGALRM, self._alarm_handler)
        ...
        def _alarm_handler(self, *_):
            super().force_update(full_refresh=True)
    ...
    class _SignalState():
        ...
        def set(self, signalnum, handler):
            ...
            # Call alarm handler every 15 seconds

...
class _BorderManager:
    def __init__(self, frame, has_border, can_scroll, edit_account, border_start_x, border_end_y):
        """
        ...
        self._border_start_x = border_start_x
        self._border_end_y = border_end_y
    ...
    def draw(self):
        ...
        if self.has_border:
            ...
            if self._edit_account:
                height = frame.canvas.height - self._border_end_y
                start = self._border_start_x
            else:
...
class Frame(Effect):
    ...
    def __init__(self, screen, height, width, data=None, on_load=None,
                 ...
                 can_scroll=True, edit_account=False, border_start_x=0, border_end_y=0):
        """
        ...
        self._border_mgr = _BorderManager(self, has_border, can_scroll, edit_account, border_start_x, border_end_y)

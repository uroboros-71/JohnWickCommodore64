...
class Layout():
    ...
    __slots__ = ["_column_sizes", "_columns", "_frame", "_has_focus", "_live_col", "_live_widget",
                 "_fill_frame", "_gutter", "_offset_max", "_label_offset"]

    def __init__(self, columns, fill_frame=False, gutter=0, offset_max=False, label_offset=0):
        """
    ...
    def fix(self, start_x, start_y, max_width, max_height):
        ...
        for i, column in enumerate(self._columns):
            ...
            if self._label_offset == 0:
                ...
                offset = offset + self._label_offset

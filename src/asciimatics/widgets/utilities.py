...
THEMES = {
    ...
    "green": defaultdict(
        ...
        {
            "disabled": (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_BLACK),
            "invalid": (Screen.COLOUR_BLACK, Screen.A_NORMAL, Screen.COLOUR_RED),
            "label": (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_BLACK),
            "label_reverse": (Screen.COLOUR_GREEN, Screen.A_REVERSE, Screen.COLOUR_BLACK),
            ...
            "button_reverse": (Screen.COLOUR_GREEN, Screen.A_REVERSE, Screen.COLOUR_BLACK),
            "edit_text": (Screen.COLOUR_GREEN, Screen.A_REVERSE, Screen.COLOUR_BLACK),
            "edit_text_reverse": (Screen.COLOUR_GREEN, Screen.A_REVERSE, Screen.COLOUR_BLACK),
            "selected_focus_field": (Screen.COLOUR_GREEN, Screen.A_REVERSE, Screen.COLOUR_BLACK),
            "focus_edit_text": (Screen.COLOUR_GREEN, Screen.A_REVERSE, Screen.COLOUR_BLACK),
            "readonly": (Screen.COLOUR_GREEN, Screen.A_REVERSE, Screen.COLOUR_BLUE),
            "focus_button": (Screen.COLOUR_GREEN, Screen.A_REVERSE, Screen.COLOUR_BLACK),
            "selected_focus_control": (Screen.COLOUR_GREEN, Screen.A_REVERSE, Screen.COLOUR_BLACK),
        }
    ),
    "transmit_green": defaultdict(
        lambda: (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_BLACK),
        {
            "readonly": (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_BLUE),
            "edit_text": (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_BLACK),
            "edit_text_reverse": (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_BLACK),
        }
    ),
    "bright": defaultdict(
    ...
    "warning": defaultdict(
        ...
        {
            "label": (Screen.COLOUR_GREEN, Screen.A_BOLD, Screen.COLOUR_RED),
            "title": (Screen.COLOUR_GREEN, Screen.A_BOLD, Screen.COLOUR_RED),
            "focus_edit_text": (Screen.COLOUR_GREEN, Screen.A_BOLD, Screen.COLOUR_RED),
            "focus_field": (Screen.COLOUR_GREEN, Screen.A_BOLD, Screen.COLOUR_RED),
            "focus_button": (Screen.COLOUR_GREEN, Screen.A_BOLD, Screen.COLOUR_YELLOW),
            "focus_control": (Screen.COLOUR_GREEN, Screen.A_BOLD, Screen.COLOUR_RED),
            "disabled": (Screen.COLOUR_GREEN, Screen.A_BOLD, Screen.COLOUR_RED),
            "shadow": (Screen.COLOUR_BLACK, None, Screen.COLOUR_BLACK),
        }

    ),
    "popupdialog": defaultdict(
        lambda: (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_BLACK),
        {
            "invalid": (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_RED),
            "label": (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_BLACK),
            "title": (Screen.COLOUR_GREEN, Screen.A_NORMAL, Screen.COLOUR_BLACK),
